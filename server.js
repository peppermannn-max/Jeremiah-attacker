...
app.post('/api/attack', (req, res) => {
  const attack = { id: Date.now().toString(36) + Math.random().toString(36).slice(2, 8), at: new Date().toISOString() };
...
server.listen(PORT, () => console.log(`Jeremiah Attack Tracker running on port ${PORT}`));
